      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              errors.tenantIdentifier ? "border-red-500" : "border-gray-300"
            }`}
        ...
        <div>
          ...
          {errors.environment && (
            <p className="text-red-500 text-sm mt-1">{errors.environment}</p>
          )}
        </div>
        ...
        <div>
          ...
          <select
            ...
            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              errors.dataRegion ? "border-red-500" : "border-gray-300"
            }`}
          ...
          {errors.dataRegion && (
            <p className="text-red-500 text-sm mt-1">{errors.dataRegion}</p>
          )}
        </div>
      </div>
        ...
        <label className="flex items-center space-x-2 cursor-pointer">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Enable support for multiple currencies across accounts
            </p>
          </div>
        </label>
      </div>
